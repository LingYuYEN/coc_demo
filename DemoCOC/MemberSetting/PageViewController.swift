...
class PageViewController: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        self.viewControllerList.append(self.getViewController(withStoryboardID: "MemberSettingPage1VC"))
//        self.viewControllerList.append(self.getViewController(withStoryboardID: "MemberSettingPage2VC"))

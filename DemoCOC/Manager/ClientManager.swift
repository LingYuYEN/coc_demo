...
class ClientManager: Transform {
    ...
    ///
    /// - Parameters:
    ///     - parameters: addValue(value, forHTTPHeaderField: key)
    func getJsonData(method: HTTPMethod = .post, url: URL, parameters: [String: String]? = nil, body: Data? = nil, sec: TimeInterval = 10, finish: ((Data?) -> Void)? = nil) {
    ...
    func getJsonObject(method: HTTPMethod = .post, url: URL, parameters: [String: String]? = nil, body: Data? = nil, sec: TimeInterval = 10, finish: ((Any?) -> Void)? = nil) {
        self.getJsonData(method: method, url: url, parameters: parameters, body: body, sec: sec) {
...
extension Data {
    ...
    mutating func appendPOSTParameter(name: String?, value: Any?) {
